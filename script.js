...
window.addEventListener('scroll', function(){
    ...
    Layer2.style.transform = 'translateY(' + value * 0.1 + 'px)';
    Layer3.style.transform = 'translateY(' + value * 0.15 + 'px)';
    Layer4.style.transform = 'translateY(' + value * 0.2 + 'px)';
    Layer5.style.transform = 'translateY(' + value * 0.3 + 'px)';
    Layer6.style.transform = 'translateY(' + value * 0.4 + 'px)';
    Layer7.style.transform = 'translateY(' + value * 0.5 + 'px)';
